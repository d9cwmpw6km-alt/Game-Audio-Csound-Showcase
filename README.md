# Game Audio & Csound SFX Showcase
...
- Visuals: Custom video showcase pairing synthesized audio with thematic pixel art assets.

## 📄 Csound Source Code
All Csound synthesis scripts (`.csd`) are available in this repository for technical review.
